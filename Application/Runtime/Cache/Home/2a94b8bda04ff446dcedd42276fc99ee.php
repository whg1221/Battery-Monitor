    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="<?php echo U('Login/logout');?>"><i class="fa fa-book"></i> <span>退出登录</span></a></li>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    您好，<?php echo session('username');?>  [ <a href="<?php echo U('Users/proinfo');?>"><?php echo session('username');?></a> ]，
