...
<body class="blue-background">
    ...
    <div class="wrapper wrapper-patch">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#history" aria-controls="history" role="tab" data-toggle="tab">历史记录</a></li>
            <li role="presentation"><a href="#parameter" aria-controls="parameter" role="tab" data-toggle="tab">参数标定</a></li>
            <li role="presentation"><a href="#battery" aria-controls="battery" role="tab" data-toggle="tab">电池列阵</a></li>
